...
function initOrb(containerId, options = {}) {
    ...
    // Attach to window since container may have pointer-events: none
    ...
    const update = t => {
        ...
        program.uniforms.backgroundColor.value = hexToVec3(config.backgroundColor);
